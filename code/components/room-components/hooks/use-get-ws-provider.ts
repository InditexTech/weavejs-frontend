...
import { WeaveStoreAzureWebPubsub, WeaveStoreAzureWebPubsubConnectionStatus } from "@inditextech/weavejs-store-azure-web-pubsub";
import React from "react";

function useGetWsProvider({ loadedParams, getUser }: {
    ...
    const wsProvider = React.useMemo(() => {
        ...
        return null;
    }, [getUser, loadedParams, onConnectionStatusChangeHandler, onFetchConnectionUrlHandler, room])
